<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Каталог для тест-драйва</h2>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white rounded shadow p-4">
                <form method="get" action="{{ route('client.catalog.test-drives') }}" class="grid grid-cols-1 md:grid-cols-5 gap-3 text-sm">
                    <input
                        type="text"
                        name="search"
                    ...
                    <div class="md:col-span-5 flex items-center justify-between gap-3">
                        ...
                        <a href="{{ route('client.catalog.test-drives') }}" class="text-xs text-gray-500">Сбросить фильтры</a>
                    </div>
                </form>
            </div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="p-4 space-y-2">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="{{ route('client.catalog.test-drives.show', $car) }}" class="relative z-20 px-3 py-1.5 rounded bg-gray-800 text-white text-xs">
                                        Записаться
                                    </a>
                                </div>
                            </div>
